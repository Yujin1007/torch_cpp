...
// void Actor::state_update(VectorXd _x)
// {   
//     current_x = _x
// }
...
{       
    ...
    x_buffer.setZero(timewindow, input_size);
    buffer.setZero(timewindow,input_size);

    _FcW1.setZero(hidden_units, output_size);
